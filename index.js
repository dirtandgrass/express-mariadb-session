...
var debug = {
	log: require('debug')('express-mariadb-session:log'),
	error: require('debug')('express-mariadb-session:error')
};
...
module.exports = function(session) {
	...
	var MariaDBStore = function(options, connection, cb) {
		...
		if (!this.connection) {
			this.connection = mariadb.createPool(this.options);
		}
	...
	util.inherits(MariaDBStore, Store);

	MariaDBStore.prototype.defaultOptions = {
	...
	MariaDBStore.prototype.setOptions = function(options) {
	...
	MariaDBStore.prototype.validateOptions = function(options) {
	...
	MariaDBStore.prototype.createDatabaseTable = function(cb) {
	...
	MariaDBStore.prototype.get = function(session_id, cb) {
	...
	MariaDBStore.prototype.set = function(session_id, data, cb) {
	...
	MariaDBStore.prototype.touch = function(session_id, data, cb) {
	...
	MariaDBStore.prototype.destroy = function(session_id, cb) {
	...
	MariaDBStore.prototype.length = function(cb) {
	...
	MariaDBStore.prototype.all = function(cb) {
	...
	MariaDBStore.prototype.clear = function(cb) {
	...
	MariaDBStore.prototype.clearExpiredSessions = function(cb) {
	...
	MariaDBStore.prototype.query = function(sql, params, cb) {
	...
	MariaDBStore.prototype.setExpirationInterval = function(interval) {
	...
	MariaDBStore.prototype.clearExpirationInterval = function() {
	...
	MariaDBStore.prototype.close = function(cb) {
	...
	if (constructorArgs) {
		...
		return new (MariaDBStore.bind.apply(MariaDBStore, [undefined/* context */].concat(constructorArgs)))();
	}
